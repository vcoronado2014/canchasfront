...
import type { Club } from 'src/auth/auth-types';
...
export const _clubs: Club[] = [
  {
    id: 1,
    nombre: 'Club Deportivo Santiago',
    direccion: 'Av. Las Condes 1234',
    telefono: '+56 9 1111 1111',
    regionCodigo: 'RM',
    regionNombre: 'Región Metropolitana',
    comunaCodigo: 'LASCONDES',
    ...
    descripcion:
      'Complejo deportivo con canchas de fútbol y pádel.',
    subdominio: 'club-santiago',
    estadoSuscripcion: 'Activa',
    fechaProxVencimiento: '2027-01-15',
  },

  {
    ...
    regionCodigo: 'RM',
    regionNombre: 'Región Metropolitana',
    comunaCodigo: 'VITACURA',
    comunaNombre: 'Vitacura',
    fotoPrincipalUrl:
      'https://images.unsplash.com/photo-1517649763962-0c623066013b?auto=format&fit=crop&w=900&q=80',
    descripcion:
      'Especialistas en tenis y fútbol.',
    subdominio: 'club-norte',
    estadoSuscripcion: 'Activa',
  },
